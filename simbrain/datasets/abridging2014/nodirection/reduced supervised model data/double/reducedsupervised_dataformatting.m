...
rowcombos = nchoosek(1:short_runs, 2); 
rowperm_count = length(rowcombos)*factorial(2); 
idx = 1;
...
%         index_targ = perms(x,2); 
        ...
        for z = 1:rowperms_per_pair
            ...
            for p = 1:4
                subject_input_data(idx,2:3) = double_short;
    ...
    input_filename = strcat(subjects{x}, '_inputdataset.csv');
    target_filename = strcat(subjects{x}, '_targetdataset.csv'); 
