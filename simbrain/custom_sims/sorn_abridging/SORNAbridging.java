...
public class SORNAbridging extends RegisteredSimulation {
  ...
  */
  ...
  public void run() {
    ...
    sim.getWorkspace().openWorkspace(new File("scripts" + FS + "scriptmenu" + FS + "SORNModWithAbridgingSimplified.zip"));
  ...
  private void setupStimulusNetwork() {
    ...
    skinReceptors = (NeuronGroup) stimulusNetwork.getGroupByLabel("Mechanoreceptors");
