...
def main():
	...
	O  = np.load( 'given_skin_SOM_weights_64_sl.npy' )
	print '...Ok!'
	...
	plt.savefig( "D:/Documents/SpyderProjects/Rougier receptive field structure codes (all meant to be the same)/PLoS One (unedited)/rf_locations_generated5000SLweights2D_response_64.png" ); plt.show()
	plt.figure( figsize=(7,7) )
	plot_statistics( size, 100 )
	# plt.savefig( "D:/Documents/SpyderProjects/Rougier receptive field structure codes (all meant to be the same)/PLoS One (unedited)/rf_histogram.png" )
	print '...Done!'
